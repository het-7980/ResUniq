...
/// --dart-define-from-file=dart_defines.json (containing GEMINI_API_KEY)
///
/// This keeps the key out of source control, but it is still part of the
/// compiled Flutter client and can be extracted from the APK. This project
/// stays on Firebase's free Spark plan (no Cloud Functions/Blaze), so the
/// Gemini call is made directly from the client instead of through a
