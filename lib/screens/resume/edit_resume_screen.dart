...
class EditResumeScreen extends StatelessWidget {
  ...
  static const _sections = [
    ...
    ('Additional Information', _hasAdditionalInformation),
  ];
  ...
  static bool _hasAdditionalInformation(ResumeDocument r) =>
      r.customFields.isNotEmpty || r.userCustomSections.isNotEmpty;
